...
package kr.co.actsone.common
{
	...
	public  class DataGridManager
	{
		...
		public  var labelFuncLib:LabelFunctionLib;
...
//		{			
//			rgItemRenderer(col,value,isHeaderRenderer);
//		}
//		
//		
		public function  rgItemRenderer(col:ExAdvancedDataGridColumn, value:String , isHeaderRenderer:Boolean = false):void
		{
			var itemRendererCls:ClassFactory;
			var itemEditorCls:ClassFactory;
			var editDataField:String="";
            
				 if (value == ColumnType.RADIOBUTTON)
				 {
			...
			switch(proName)
			{
				...
				case "headerRenderer":
					if(col is ExAdvancedDataGridColumn)
						this.gridone.setItemRenderer(col as ExAdvancedDataGridColumn,value.toString().toUpperCase(),true);
					break;
				case "itemRenderer":
					this.gridone.setItemRenderer(col as ExAdvancedDataGridColumn,value.toString().toUpperCase(),false);
					break;
		...
		private function dg_itemClickHandler(event:ListEvent):void
		{
			...
			if (this.datagrid.selectCell==false && this.bselect)
			{
				this.setDataGridProperty("selectCell",true);
		...
		public var bMouseScroll:Boolean=false;
		public var bMouseItemClick:Boolean=false;
		public function dg_scrollDatagridHandler(event:ScrollEvent):void
		{
			...
			if (this.datagrid.selectCell)
			{
				this.setDataGridProperty("selectCell",false);
				bselect=true;
			}
